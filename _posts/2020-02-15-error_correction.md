...
![](/images/2020-02-15-error_correction_files/origbits.png "Figure 1: Original bit string."){:width="70%"}
...
![](/images/2020-02-15-error_correction_files/c1bit.png "Figure 2: Bit string with bit $b_5$ corrupted. First parity bit is checked."){:width="70%"}

Next, the second parity counts an *even* number of 1's in the positions 2,3,6, and 7 so $c_2=0$.

![](/images/2020-02-15-error_correction_files/c2bit.png "Figure 3: Second parity bit is checked."){:width="70%"}

The third parity counts an *odd* number of 1's in the positions 4,5,6, and 7 so $c_3=1$. 

![](/images/2020-02-15-error_correction_files/c3bit.png "Figure 4: Third parity bit is checked."){:width="70%")
